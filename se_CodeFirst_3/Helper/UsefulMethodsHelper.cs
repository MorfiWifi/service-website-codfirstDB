...
namespace se_CodeFirst_3.Helper
{
    public class UsefulMethodsHelper
    {
        ...
        public bool CompareDatesForWhereClause(DateTime date1, DateTime date2)
        {
            bool result = (date1.Date.Year > date2.Year) ||
                         (date1.Date.Year == date2.Year && date1.Date.Month > date2.Month) ||
                         (date1.Date.Year == date2.Year && date1.Date.Month == date2.Month && date1.Date.Day == date2.Day);
